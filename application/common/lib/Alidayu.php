...
use Aliyun\api_sdk\lib\Core\Config;
...
class Alidayu
{
    const LOG_TAG = "app\common\lib\Alidayu.php";
    ...
    public function setSmsIdentify($phone = 0)
    {
        ...
        $request->setSignName(config('alidayu.signName'));
...
//        $request->setSmsUpExtendCode("1234567");
        ...
        if($acsResponse -> Code == "OK"){
            ...
            Log::write(self::LOG_TAG."-----------".json_encode($acsResponse));
        }
        return false;
    }
